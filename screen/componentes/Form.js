...
export const LoginOptions = {
    fields: {
        nombre:  { template:Inout, config:{ placeholder:"Ingrese su nombre", label:"Nombre *", password:false, secureTextEntry:false, type_input:'default' } },

        apellido:{ template:Inout, config:{ placeholder:"Ingrese su apellido",label:"Apellido *", secureTextEntry:false, password:false, type_input:'default'} },
        conocido:{ template:Inout, config:{ placeholder:"¿Como le dicen?",label:"Nombre que le gusta utilizar",
        secureTextEntry:false, password:false, type_input:'default'} },
        ...
        telfono_celular:{ template:Inout, config:{ placeholder:"Ingrese su teléfono celular", label:"Teléfono celular", secureTextEntry:false, password:false, type_input:'numeric'} },
        telefono_domiciliar:{ template:Inout, config:{ placeholder:"Ingrese su teléfono domiciliar", label:"Teléfono domiciliar",secureTextEntry:false, password:false, type_input:'numeric'} },
        correo_electronico:{ template:Inout, config:{ placeholder:"Ingrese su correo electrónico",label:"Correo electrónico", secureTextEntry:false, password:false, type_input:'email-address'} },
        nacionalidad:{ template:Inout, config:{placeholder:"Ingrese su nacionalidad",label:"Nacionalidad", secureTextEntry:false, password:false, type_input:'default'}},
        ...
        num_documento:{ template:Inout, config:{ placeholder:"Ingrese su número de documento",label:"Documento de  Identificación", secureTextEntry:false, password:false, type_input:'default'} },
        direccion_domicilio:{template:Inout, config:{ placeholder:"Ingrese su dirección domiciliar", label:"Dirección",secureTextEntry:false, password:false, type_input:'default'} },
        ...
        seguro_medico:{ template:Inout, config:{ placeholder:"Tipo Seguro Médico",label:"Tipo Seguro Médico", secureTextEntry:false, password:false, type_input:'default'} },
        referido_por:{ template:Inout, config:{ placeholder:"Ingrese por quíen fue referido", label:"Referido por",secureTextEntry:false, password:false, type_input:'default'} },
        ...
        lugar_trabajo:{ template:Inout, config:{ placeholder:"Ingrese lugar de trabajo", label:"Lugar de trabajo",secureTextEntry:false, password:false, type_input:'default'} },
        telefono_trabajo:{ template:Inout, config:{ placeholder:"Ingrese su teléfono de oficina", label:"Teléfono de oficina",secureTextEntry:false, password:false, type_input:'numeric'} },
        conyugue:{ template:Inout, config:{ placeholder:"Ingrese el nombre de su cónyuge", label:"Nombre del Cónyuge",secureTextEntry:false, password:false, type_input:'default'} },
        telefono_conyugue:{ template:Inout, config:{ placeholder:"Ingrese el teléfono del cónyuge", label:"Teléfono del cónyuge",secureTextEntry:false, password:false, type_input:'numeric'} },
...
export const MedicOptions = {
    fields: {
        medicamentio_que_utiliza:{template:Inout, config:{ placeholder:"Ingrese medicamento que utiliza",label:"Medicamentos que utiliza", secureTextEntry:false, password:false, type_input:'default'} },
        alergias:{template:Inout, config:{ placeholder:"Ingrese sus alérgias",label:"Alérgico a", secureTextEntry:false, password:false, type_input:'default'} }, 
    }
};
export const NinoOptions = {
    fields: {
        nombre_padre:{template:Inout, config:{ placeholder:"Ingrese el nombre del padre",label:"Nombre del Padre", secureTextEntry:false, password:false, type_input:'default'} },
        telefono_padre:{template:Inout, config:{ placeholder:"Ingrese el teléfono del padre",label:"Teléfono", secureTextEntry:false, password:false, type_input:'numeric'} },
        ocupacion_padre:{template:Inout, config:{ placeholder:"Ingrese la ocupación del padre",label:"Ocupación", secureTextEntry:false, password:false, type_input:'default'} },
        nombre_madre:{template:Inout, config:{ placeholder:"Ingrese el nombre de la madre",label:"Nombre de la Madre", secureTextEntry:false, password:false, type_input:'default'} },
        telefono_madre:{template:Inout, config:{ placeholder:"Ingrese el teléfono de la madre", label:"Teléfono",secureTextEntry:false, password:false, type_input:'numeric'} },
        ocupacion_madre:{template:Inout, config:{ placeholder:"Ingrese la ocupación de la madre",label:"Ocupación ", secureTextEntry:false, password:false, type_input:'default'} },
    }
};
